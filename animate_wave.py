...
cmd = f"{repertoire}{executable} {input_filename} f_hat={f_hat} h00={h00} CFL={CFL} initialization={initialization} L={L} tfin={tfin} nx={nx} n_init={n_init} output={output_base}"
